# 0.11 (next)
+ Changed the shield recipe to require 4 nuggets and fewer planks so it's more easily accessible.
...
+ Updated the mod to Fabric API 0.116.1 & BTWR: Shared Library 0.55
